...
//TESTE COM 2 TELEFONES
//let telefone2 = new Telefone()
//telefone2.ddd='11'
//telefone2.numero = '1234-5678'
...
let telefoneDependente

cliente.telefones.forEach(telefone => {
    telefoneDependente = (telefone.clonar() as Telefone)
    dependente.telefones.push(telefoneDependente)
});
